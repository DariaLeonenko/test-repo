...
const file__3_1_order_proto_rawDesc = "" +
	"\n" +
	"\x0f3_1/order.proto\x12\x03api\"G\n" +
	"\x05Order\x12\x0e\n" +
...
var (
	...
	file__3_1_order_proto_rawDescData []byte
)

func file__3_1_order_proto_rawDescGZIP() []byte {
	file__3_1_order_proto_rawDescOnce.Do(func() {
		file__3_1_order_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file__3_1_order_proto_rawDesc), len(file__3_1_order_proto_rawDesc)))
	})
...
func file__3_1_order_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file__3_1_order_proto_rawDesc), len(file__3_1_order_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
